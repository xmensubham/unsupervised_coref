...
% ========== PACKAGES ==========
% NOTE: Compile with XeLaTeX or LuaLaTeX for Devanagari Hindi text support
% If using pdflatex, replace Devanagari examples with romanized equivalents
\usepackage{fontspec}
...
\begin{center}
\textit{``राम स्कूल गया। वह खुश था।''}\\
(राम विद्यालय गया। वह प्रसन्न था।)
\end{center}

A coreference resolver must identify that \textit{राम} and \textit{वह} (he) refer to the same person and place them in the same cluster. This seemingly simple inference requires the system to understand pronouns, nominal phrases, discourse structure, and the morphological properties of a highly inflectional language. It is a prerequisite for high-quality machine translation, question answering, dialogue systems, information extraction, and text summarisation.
...
\begin{enumerate}
    ...
    \item \textbf{Manually create an annotated coreference dataset} of 1248 mention annotations, since no suitable Hindi dataset was available.
...
\begin{itemize}
    ...
    \item A manually annotated Hindi coreference dataset of 1248 mention spans.
...
\begin{center}
\textit{``राम स्कूल गया। वह बहुत खुश था। उसने अपने दोस्तों से बात की।''}\\
(राम विद्यालय गया। वह बहुत प्रसन्न था। उसने अपने मित्रों से बात की।)
\end{center}

\textbf{Gold coreference clusters:}
\begin{itemize}
    \item Cluster 1: \{राम, वह, उसने\}
\end{itemize}

\textbf{System predicted clusters:}
\begin{itemize}
    \item Cluster 1 (correct): \{राम, वह, उसने\} --- pronoun flags and clause heuristics correctly triggered
\end{itemize}

\textbf{Failure example:}
\begin{center}
\textit{``सीमा और प्रिया दोनों स्कूल गईं। वह बहुत थक गई थी।''}\\
(सीमा और प्रिया दोनों विद्यालय गईं। वह बहुत थक गई थी।)
\end{center}

\textbf{System predicted:} \{सीमा, वह\} --- the system incorrectly resolved the pronoun to the first-mentioned entity rather than recognising the ambiguity or the plural-to-singular mismatch.
