...
\begin{center}
\textit{``{\hindifont राम स्कूल गया। वह खुश था।}''}\\
({\hindifont राम विद्यालय गया। वह प्रसन्न था।})
\end{center}

A coreference resolver must identify that \textit{{\hindifont राम}} and \textit{{\hindifont वह}} (he) refer to the same person and place them in the same cluster. This seemingly simple inference requires the system to understand pronouns, nominal phrases, discourse structure, and the morphological properties of a highly inflectional language. It is a prerequisite for high-quality machine translation, question answering, dialogue systems, information extraction, and text summarisation.
...
\begin{center}
\textit{``{\hindifont राम स्कूल गया। वह बहुत खुश था। उसने अपने दोस्तों से बात की।}''}\\
...
\begin{center}
\textit{``{\hindifont सीमा और प्रिया दोनों स्कूल गईं। वह बहुत थक गई थी।}''}\\
